...
describe('Sample nbaEndpoints', function() {
  ...
  it('should get the proper team data (Energy)', function(done) {
  ...
  it('should get the proper team schedule (Energy)', function(done) {
    nbaEndpoints.getTeamSchedule({team: 'energy'}).then(function (teamScheduleResponse) {
  ...
  it('should get the proper visiting & home teams', function(done) {
    nbaEndpoints.getTeamSchedule({team: 'energy'}).then(function (teamScheduleResponse) {
      var games = teamScheduleResponse.getGames();
  ...
  it('should get the proper broadcasters', function(done) {
    nbaEndpoints.getTeamSchedule({team: 'energy'}).then(function (teamScheduleResponse) {
      var games = teamScheduleResponse.getGames();
